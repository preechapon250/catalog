...
- Kubernetes 1.22+ (recommended 1.30+)
...
```console
helm install goldilocks oci://dhi.io/goldilocks-chart --version <version> \
...
pod/goldilocks-goldilocks-chart-controller-7849d5f99b-56gn9   1/1     Running   0          14s
pod/goldilocks-goldilocks-chart-dashboard-f695f59b4-whgzm     1/1     Running   0          14s
pod/goldilocks-goldilocks-chart-dashboard-f695f59b4-znwdb     1/1     Running   0          14s

NAME                                            TYPE        CLUSTER-IP      EXTERNAL-IP   PORT(S)   AGE
service/goldilocks-goldilocks-chart-dashboard   ClusterIP   10.105.25.230   <none>        80/TCP    14s
service/kubernetes                              ClusterIP   10.96.0.1       <none>        443/TCP   29h

NAME                                                     READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/goldilocks-goldilocks-chart-controller   1/1     1            1           14s
deployment.apps/goldilocks-goldilocks-chart-dashboard    2/2     2            2           14s

NAME                                                                DESIRED   CURRENT   READY   AGE
replicaset.apps/goldilocks-goldilocks-chart-controller-7849d5f99b   1         1         1       14s
replicaset.apps/goldilocks-goldilocks-chart-dashboard-f695f59b4     2         2         2       14s
```

Then you should be able to open a port forward rule and check the dashboard state:

```bash
kubectl port-forward service/goldilocks-goldilocks-chart-dashboard 8080:80
```

And navigate to `http://localhost:8080` to open the Goldilocks dashboard.
