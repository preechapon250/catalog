...
```console
helm install my-kube-vip oci://dhi.io/kube-vip-chart --version <version> \
...
**Important:** You must provide a valid `config.address` for the virtual IP that kube-vip will manage.

#### Step 4: Verify the installation

The DaemonSet's pods should show up and running almost immediately:

```bash
$ kubectl get pods -n kube-system -l app.kubernetes.io/name=kube-vip-chart
NAME                      READY   STATUS    RESTARTS   AGE
my-kube-vip-chart-abcde   1/1     Running   0          15s
```
