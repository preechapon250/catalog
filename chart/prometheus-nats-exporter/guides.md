...
```console
helm install my-nats-exporter oci://dhi.io/prometheus-nats-exporter-chart --version <version> \
  --set "image.imagePullSecrets[0].name=helm-pull-secret" \
```
...
pod/test-prometheus-nats-exporter-chart-5f8f7445c5-g5vh4   1/1     Running   0          30s

NAME                                          TYPE        CLUSTER-IP    EXTERNAL-IP   PORT(S)   AGE
service/kubernetes                            ClusterIP   10.43.0.1     <none>        443/TCP   40s
service/test-prometheus-nats-exporter-chart   ClusterIP   10.43.170.4   <none>        80/TCP    30s

NAME                                                  READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/test-prometheus-nats-exporter-chart   1/1     1            1           30s

NAME                                                             DESIRED   CURRENT   READY   AGE
replicaset.apps/test-prometheus-nats-exporter-chart-5f8f7445c5   1         1         1       30s
```
