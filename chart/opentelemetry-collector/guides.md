...
```console
helm install test oci://dhi.io/opentelemetry-collector-chart --version <version> \
...
pod/test-opentelemetry-collector-chart-5f4ddb65b6-mdb2r   1/1     Running   0          29s

NAME                                         TYPE        CLUSTER-IP     EXTERNAL-IP   PORT(S)                                                   AGE
service/kubernetes                           ClusterIP   10.43.0.1      <none>        443/TCP                                                   43s
service/test-opentelemetry-collector-chart   ClusterIP   10.43.71.103   <none>        6831/UDP,14250/TCP,14268/TCP,4317/TCP,4318/TCP,9411/TCP   29s

NAME                                                 READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/test-opentelemetry-collector-chart   1/1     1            1           29s
```
