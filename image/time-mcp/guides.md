...
The Time MCP Server provides tools for time queries and timezone conversions for LLMs, enabling AI applications to work
accurately with dates, times, and timezones through the Model Context Protocol.
...
1. **Avoid Abbreviations**: Don't use abbreviations like PST, EST (they're ambiguous)
1. **Handle DST**: IANA identifiers automatically handle daylight saving time
1. **UTC for Storage**: Store timestamps in UTC, convert for display
1. **Explicit Timezone**: Always specify timezone explicitly when needed
...
- [Time MCP Server Documentation](https://github.com/modelcontextprotocol/servers/tree/main/src/time)
