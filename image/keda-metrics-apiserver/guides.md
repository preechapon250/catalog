...
```
kubectl patch deployment/keda-metrics-apiserver --patch '{"spec": {"template": {"spec": {"containers": [{"name": "keda-metrics-apiserver", "image": "dhi.io/keda-metrics-apiserver:<tag>"}]}}}}' -n keda
```
